...
let initialState = {
  productsList:[{name:"Caramelo", description:"dessert", price:10, count:0, category:"food", image:foodImg[0]},
  {name:"Apple pen", description:"pen", price:3000, count:0, category:"electronics", image:electImage[2]},
  {name:"Italian Pizza", description:"main course", price:10, count:0, category:"food", image:foodImg[1]},
  {name:"Apple watch", description:"watch", price:3000, count:0, category:"electronics", image:electImage[1]},
  {name:"Lemonade", description:"drink", price:10, count:0, category:"food", image: foodImg[2]},
  {name:"Iphone12 Pro", description:"phone", price:3000, count:0, category:"electronics", image:electImage[0] }] ,
